 ...
 const deletePayroll= (employee) => {
  ...
  const displayEmployees = employees
    ...
    .map((employee) => {
      ...
      <Dropdown.Menu>
      <Dropdown.Item ><Link to={`/edit/${employee.id}`}><button className='btn btn-warning'>Edit</button></Link></Dropdown.Item>     
      <Dropdown.Item ><Link to={`/bank/${employee.id}`}><button className='btn btn-primary'>Bank</button></Link></Dropdown.Item>
      <Dropdown.Item><button className='btn btn-dark' onClick={()=>{handleCalculation(employee.id)}}>Calculate</button></Dropdown.Item>     

      <PopUpWithYesNoField  employee={employee} handleDelete={deletePayroll}/>
  ...
  return (
    ...
    <Link to={"/banks/"} className='btn btn-dark'>Amount Transfer</Link>
    <br/>

    <div className='btn btn-primary' onClick={downloadPayrollCSV}>Download to excel</div>
    <div>
